...
public class sd_loadline extends BaseHullMod {
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        tooltip.addPara("Increases peak operating time by 240 seconds.", padS, Misc.getHighlightColor(), "240 seconds");
        tooltip.addPara("Reduces CR degradation rate by 25%%.", padS, Misc.getHighlightColor(), "25%");
        tooltip.addPara("Reduces overload duration by 25%%.", padS, Misc.getHighlightColor(), "25%");
        tooltip.addPara("Improves module durability by 25%%.", padS, Misc.getHighlightColor(), "25%");
        tooltip.addPara("Reduces the risk of malfunctions by 50%%.", padS, Misc.getHighlightColor(), "50%");
        tooltip.addPara("Improves active venting by 33%%.", padS, Misc.getHighlightColor(), "33%");

        tooltip.addPara("When performance is not steady:", pad, Misc.getNegativeHighlightColor(), "steady");
        tooltip.addPara("- Weapon rate of fire, system regeneration rate, top speed, maneuverability, shield unfold rate, and fighter replacement rate are all reduced by 10%%.", padS, Misc.getNegativeHighlightColor(), "10%");
        tooltip.addPara("- Flux dissipation above the hull's baseline spec is clamped to 67%% effectiveness.", padS, Misc.getNegativeHighlightColor(), "clamped to 67%");
        tooltip.addPara("This hullmod cannot be built in.", pad);
