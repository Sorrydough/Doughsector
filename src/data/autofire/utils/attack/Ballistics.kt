...
import data.autofire.utils.extensions.absoluteArcFacing
...
fun willHitCircumference(weapon: WeaponAPI, target: AttackTarget, params: BallisticParams): Float? = solve(
    projectileCoords(weapon, target, params), target.radius, 0f, 0f)
